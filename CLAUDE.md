...
Respetar el límite del Sprint 2: existe identidad estructural, persistencia local y adaptador Cloud, junto con una UI de demostración. No iniciar Sprint 3 sin instrucción expresa. Conservar la separación entre `domain`, `application`, adaptadores de las apps, `ui` y `features`.
