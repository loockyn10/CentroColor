...
El Sprint 1 está limitado a la fundación técnica. No iniciar Sprint 2 ni implementar clientes, ventas, agenda, eventos, marquetería, autenticación o sincronización sin una solicitud nueva. Mantener `packages/domain` sin dependencias de UI o persistencia y ubicar los adaptadores concretos dentro de cada app.
