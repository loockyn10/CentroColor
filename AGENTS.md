...
El Sprint 3 incorpora Supabase Auth, Profile, BusinessMembership, RLS y autenticación offline limitada de Desktop. No iniciar Sprint 4 ni implementar clientes, ventas, agenda, eventos, marquetería, administración compleja de usuarios o sincronización sin una solicitud nueva. Mantener `packages/domain` sin dependencias de UI o persistencia y ubicar los adaptadores concretos dentro de cada app.
